...
import { createExpense, getExpense } from "./routes/expenseRoute";
...
app.get("/api/expense/get-expense", authMiddleware, getExpense)
...
// Vercel detects this listen() call when entrypoint is named server.ts
app.listen(3000, () => {
